...
use \laocc\weixin\items\Api;
use \laocc\weixin\items\Auth;
use \laocc\weixin\items\Custom;
use \laocc\weixin\items\Fans;
use \laocc\weixin\items\Push;
use \laocc\weixin\items\Reply;
use \laocc\weixin\items\Media;
use \laocc\weixin\items\Menu;
use \laocc\weixin\items\Send;
use \laocc\weixin\items\Tag;
use \laocc\weixin\items\Template;

final class WeiChat extends Model
{
    ...
    public function _init(array $mpp = null, Platform $platform = null)
    {
        if (is_null($mpp)) return;
        $this->resDomain = $this->config('dim.upload.domain');
        $this->mpp = $mpp;
     ...
     *
     */
    private function tempCache(string $name, $value = null)
    {
